...
COPTIMIZE        = -O3 -mavx2 -fvectorize -mllvm -disable-wyvern-pipeline -mllvm --enable-epilogue-vectorization=false -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize
CXX              = $(LLVM_BIN_PATH)/clang++ -m64
CXXOPTIMIZE      = -O3 -mavx2 -fvectorize -mllvm -disable-wyvern-pipeline -mllvm --enable-epilogue-vectorization=false -Rpass=loop-vectorize -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize
...
FOPTIMIZE        = -O3 -mavx2 -funroll-loops
...
log_line_width   = 1020
log_timestamp    = 0
logfile          = /home/labuser/benchmarkcode/src/tmp/CPU2017.002/templogs/preenv.fprate.002.0
logname          = /home/labuser/benchmarkcode/src/tmp/CPU2017.002/templogs/preenv.fprate.002.0
lognum           = 002.0
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
notes_plat_sysinfo_010 =  running on thinkmate-x99 Sat Jan 22 16:45:18 2022
...
notes_plat_sysinfo_165 =       CPU MHz:               1294.476
...
notes_plat_sysinfo_300 =    node 0 free: 9508 MB
...
review           = 0
run              = all
runcpu           = /home/labuser/benchmarkcode/src/bin/harness/runcpu --configfile bangtian_rtclang.cfg --action build --noreportable --nopower --runmode rate --tune base:peak --size refrate 519.lbm_r --nopreenv --note-preenv --logfile /home/labuser/benchmarkcode/src/tmp/CPU2017.002/templogs/preenv.fprate.002.0 --lognum 002.0 --from_runcpu 2
rundir           = run
runmode          = rate
safe_eval        = 1
save_build_files = 
