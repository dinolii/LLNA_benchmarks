...
int main(int argc, char** argv)
{
  ...
  if(in.epsilon!=1.0 || in.sigma!=1.0) {
	  printf("WARNING: You compiled for the intrinsic version of the Lennard Jones force kernel, but changed the force parameters to non-default values. The intrinsic variant only supports 1.0 for both epsilon and sigma.");
  }
  #endif
